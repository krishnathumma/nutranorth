      ...
      <div class="row">
        <div class="col-md-12">
          <div class="card">
            ...
            <form class="needs-validation" novalidate action="/npn" method="POST" enctype= "multipart/form-data">
              @csrf
              <div class="card-body">
                ...
                <div class="row">
                  ...
                  <div class="col-lg-6">
                    <div class="form-group">
                      ...
                      <input type="text" name="name" class="form-control @error('name') is-invalid @enderror" id="name" placeholder="NPN Name" value="{{old('name')}}" required>
                      @error('name')
                ...
                <div class="row">
                  <div class="col-lg-6">
                    <div class="form-group">
                      ...
                      <input type="text" name="number" class="form-control @error('number') is-invalid @enderror" id="npn_number" placeholder="Npn Number" value="{{old('number')}}" required>
                      @error('name')
                      <span class="invalid-feedback text-danger">{{ $message }}</span>
                      @enderror
                    </div>
