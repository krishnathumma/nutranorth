...
<body class="hold-transition sidebar-mini">
    ...
    <!-- <sccript src="https://cdnjs.cloudflare.com/ajax/libs/jszip/3.10.1/jszip.min.js"></script>
    <sccript src="https://cdn.datatables.net/buttons/3.1.2/js/buttons.html5.min.js"></script>
    <sccript src="/assets/vendor/datatables/button.server-side.js"></script>
