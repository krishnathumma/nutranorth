      ...
      <div class="row">
        <div class="col-md-12">
          <div class="card">
            ...
            <form class="needs-validation" novalidate action="/employee" method="POST">
              @csrf
              <div class="card-body">
                ...
                <div class="row">
                  ...
                  <div class="col-lg-6">
                    <div class="form-group">
                      ...
                      <input type="number" name="mobile" class="form-control @error('mobile') is-invalid @enderror" id="role" placeholder="Mobile" value="{{old('mobile')}}" required>
                      @error('name')
                      <span class="invalid-feedback text-danger">{{ $message }}</span>
                      @enderror
                    </div>
